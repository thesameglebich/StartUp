        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Domen = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WebSite = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BackColor = table.Column<int>(type: "int", nullable: false),
                    FontColor = table.Column<int>(type: "int", nullable: false),
                    ButtonColor = table.Column<int>(type: "int", nullable: false),
                    PathLogo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PathWrap = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingridients_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Oplachen = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Alerg = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Birka = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentDishes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentDishes_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GraduateService = table.Column<int>(type: "int", nullable: false),
                    GraduateMenu = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentRests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentRests_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentRests_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tutelage", x => new { x.DishesId, x.IngridientsId });
                    table.ForeignKey(
                        name: "FK_Tutelage_Dishes_DishesId",
                        column: x => x.DishesId,
                        principalTable: "Dishes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tutelage_Ingridients_IngridientsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentDishes_OrderId",
                table: "CommentDishes",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentRests_OrderId",
                table: "CommentRests",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentRests_RestaurantId",
                table: "CommentRests",
                column: "RestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tutelage_IngridientsId",
                table: "Tutelage",
